...
TrianImage = "D:/Pachigo/Covid/Medical_Data_3/train/"
TestImage = "D:/Pachigo/Covid/Medical_Data_3/val/"
...
pretrained_InceptionResNetV2 = tf.keras.applications.InceptionResNetV2(input_shape=(image_size, image_size, 3),
                                                                 include_top=False, weights='imagenet')

for layer in pretrained_InceptionResNetV2.layers:
    layer.trainable = False

x1 = pretrained_InceptionResNetV2.output
...
model_IResNet = Model(inputs=pretrained_InceptionResNetV2.input, outputs=model_out)
model_IResNet.compile(optimizer=tf.keras.optimizers.Adam(learning_rate=0.0001), loss=categorical_smooth_loss,
                metrics=['accuracy'])


if __name__ == "__main__":
    history = model_IResNet.fit(training_set, validation_data=testing_set, epochs=50)
    ...
    # Saving the Model
    model_IResNet.save("model_IResNet.h5")
