...
model_Xception = Model(inputs=pretrained_Xception.input, outputs=model_out)
model_Xception.compile(optimizer=tf.keras.optimizers.Adam(learning_rate=0.0001), loss=categorical_smooth_loss,
                metrics=['accuracy'])
#model_Xception.summary()


if __name__ == "__main__":
    history = model_Xception.fit(training_set, validation_data=testing_set, epochs=50)
