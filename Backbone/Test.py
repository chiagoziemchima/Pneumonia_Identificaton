...
reconstructed_model = tf.keras.models.load_model("model_D.h5", custom_objects={'categorical_smooth_loss':categorical_smooth_loss})
...
with open("cm_ext.txt", "a") as f:
    print(cm_b, file=f)
ROC_AUC.plot_ROC(y_true, y_pred, classes=[0, 1, 2], class_labels=target_names)
ROC_AUC.plot_PrecRec(y_true, y_pred, classes=[0, 1, 2], class_labels=target_names)
