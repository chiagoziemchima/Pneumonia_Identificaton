...
x1 = pretrained_googleNet.output
...
model_G = Model(inputs=pretrained_googleNet.input, outputs=model_out)
model_G.compile(optimizer=tf.keras.optimizers.Adam(learning_rate=0.0001), loss=categorical_smooth_loss,
                metrics=['accuracy'])

if __name__ == "__main__":
    history = model_G.fit(training_set, validation_data=testing_set, epochs=50)
